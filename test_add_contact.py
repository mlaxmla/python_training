...
class TestAddContact(unittest.TestCase):
    ...
    def test_add_contact(self):
        ...
        self.create_contact(wd, firstname="aaa", middlename="bbbb", lastname="cccc", nickname="dddd", title="eeee", company="ffff", address="ggggg", home="hhhhhh", mobile="iiii"
                            , work="jjjj", fax="kkkk", email="a@q.d", email2="b@w.g", email3="c@h.d", byear="1943", ayear="1992", address2="aaaa", phone2="hhhh", notes="nnnn", phone="666")
        # logout
        wd.find_element_by_link_text("Logout").click()

    def create_contact(self, wd, firstname, middlename, lastname, nickname, title, company, address, home, mobile, work,
                       fax, email, email2, email3, byear, ayear, address2, phone2, notes, phone):
